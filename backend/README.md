...
## Project Structure
    ...
    ├── broken_forest_dev_80807  # Django project configurations
...
1. Clone this repo and `cd broken_forest_dev_80807`
...
2. Clone this repo and `cd broken_forest_dev_80807`
