"""
Django settings for broken_forest_dev_80807 project.
...
ROOT_URLCONF = 'broken_forest_dev_80807.urls'
...
WSGI_APPLICATION = 'broken_forest_dev_80807.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_forest_dev_80807 API",
    "DESCRIPTION": "API documentation for broken_forest_dev_80807 App",
    "VERSION": "v1",
}
